...
```
cd debug
cmake .. -DBUILD_TOOLS=false -DBUILD_KEEPER=false -DBUILD_HTTP=true -DBUILD_TEST=true -DWEBSOCKET:STRING=false -DBUILD_SANITIZER=false

cmake .. -DBUILD_TOOLS=false -DBUILD_KEEPER=false -DBUILD_HTTP=true -DBUILD_TEST=true -DWEBSOCKET:STRING=false -DBUILD_SANITIZER=true
```
...
cmake .. -DBUILD_TEST=true -DBUILD_SANITIZER=true
make -j20
```
...
cmake .. -DBUILD_TEST=true -DGRANT_VALUE=365 -DBUILD_TOOLS=false -DBUILD_HTTP=true -DWEBSOCKET:STRING=true


cmake .. -DBUILD_TEST=true -DGRANT_VALUE=365 -DBUILD_TOOLS=false -DBUILD_HTTP=true -DWEBSOCKET:STRING=true -DBUILD_SANITIZER=false
```
