...
RUN /root/.cargo/bin/rustup install 1.90.0 --component rustfmt --component clippy
...
COPY oracle-instantclient-basic-23.9.0.25.07-1.el8.x86_64.rpm /root/
COPY oracle-instantclient-sqlplus-23.9.0.25.07-1.el8.x86_64.rpm /root/
RUN alien -i --scripts /root/oracle-instantclient-basic-23.9.0.25.07-1.el8.x86_64.rpm
# 这个无法安装
#RUN alien -i --scripts /root/oracle-instantclient-sqlplus-23.9.0.25.07-1.el8.x86_64.rpm
